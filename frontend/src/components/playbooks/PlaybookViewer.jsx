    ...
    <div className="h-full flex flex-col overflow-hidden bg-slate-950">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3">
        <div className="prose prose-invert max-w-none text-sm">
          <ReactMarkdown
            components={{
              h1: ({ node: _node, ...props }) => <h1 className="text-xl font-bold text-slate-100 mt-4 mb-2" {...props} />,
              h2: ({ node: _node, ...props }) => <h2 className="text-lg font-bold text-slate-200 mt-3 mb-2 border-b border-slate-800/50 pb-1" {...props} />,
              h3: ({ node: _node, ...props }) => <h3 className="text-base font-semibold text-slate-300 mt-2 mb-1" {...props} />,
              p: ({ node: _node, ...props }) => <p className="text-slate-400 mb-2 leading-relaxed" {...props} />,
              ul: ({ node: _node, ...props }) => <ul className="list-disc list-inside text-slate-400 mb-2 space-y-0.5" {...props} />,
              ol: ({ node: _node, ...props }) => <ol className="list-decimal list-inside text-slate-400 mb-2 space-y-0.5" {...props} />,
              li: ({ node: _node, ...props }) => <li className="text-slate-400" {...props} />,
              ...
              blockquote: ({ node: _node, ...props }) => <blockquote className="border-l-2 border-slate-700 pl-3 italic text-slate-500 mb-2" {...props} />,
              table: ({ node: _node, ...props }) => <table className="w-full text-xs text-slate-400 mb-2 border border-slate-800/50" {...props} />,
              th: ({ node: _node, ...props }) => <th className="border border-slate-800/50 bg-slate-800/30 px-3 py-2 text-left font-semibold" {...props} />,
              td: ({ node: _node, ...props }) => <td className="border border-slate-800/50 px-3 py-2" {...props} />,
            }}
          >
            {filteredContent}
          </ReactMarkdown>
