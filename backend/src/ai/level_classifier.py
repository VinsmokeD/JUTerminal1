...
TOOLS = {
    "nmap", "sqlmap", "gobuster", "nikto", "hydra", "curl", "whatweb", "bloodhound",
    "crackmapexec", "netexec", "impacket", "mimikatz", "hashcat", "msfconsole",
    "msfvenom", "theharvester", "gophish", "dirb", "ffuf", "dirbuster", "netcat",
    "nc", "smbclient", "secretsdump", "getuserspns", "kerbrute", "gowitness",
    "ncat", "burp", "wireshark", "tcpdump", "cyberchef", "ldapsearch", "secretsdump.py",
    "getuserspns.py", "gpp-decrypt", "john the ripper", "john", "splunk", "modsecurity",
    "apache"
}
